use crate::char_star_star::OwningCharStarStar;
...
struct EnvScopedImpl {
    ...
    export_array: Option<Arc<OwningCharStarStar>>,
...
impl EnvScopedImpl {
    ...
    fn create_export_array(&self) -> Arc<OwningCharStarStar> {
        ...
        return Arc::new(OwningCharStarStar::new(export_list));
    }

    // Exported variable array used by execv.
    fn export_array(&mut self) -> Arc<OwningCharStarStar> {
...
impl EnvStack {
    ...
    pub fn export_arr(&self) -> Arc<OwningCharStarStar> {
