...
Universal variables are no longer created by default
----------------------------------------------------
...
-------------------------
- Themes can now be made color-theme-aware (i.e. light mode vs. dark mode) by including both ``[light]`` and ``[dark]`` sections in the theme file.
  See :doc:`fish_config <cmds/fish_config>`.
